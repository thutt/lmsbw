...
$(if $(findstring components,$(MAKECMDGOALS)),$(call generate_component_component,$(1)))
$(if $(findstring clean,$(MAKECMDGOALS)),$(call generate_component_clean,$(1)))
$(if $(findstring report,$(MAKECMDGOALS)),$(call generate_component_report,$(1)))
$(if $(findstring log,$(MAKECMDGOALS)),$(call generate_component_build_log,$(1)))
$(if $(findstring prerequisite-report,$(MAKECMDGOALS)),$(call generate_component_prerequisite_report,$(1)))
$(if $(findstring dependent-report,$(MAKECMDGOALS)),$(call generate_component_dependent_report,$(1)))
$(if $(findstring destdir,$(MAKECMDGOALS)),$(call generate_component_destdir,$(1)))
$(if $(findstring builddir,$(MAKECMDGOALS)),$(call generate_component_builddir,$(1)))
$(if $(findstring sourcedir,$(MAKECMDGOALS)),$(call generate_component_sourcedir,$(1)))
$(if $(findstring installdir,$(MAKECMDGOALS)),$(call generate_component_installdir,$(1)))
endef
