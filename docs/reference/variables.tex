...
\todo{document component-build-support}
\todo{document that this variable must be set when the
  load-configuration is set}
...
See \xref{api:reason} for the allowable values.
