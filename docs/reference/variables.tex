...
using \lmsbw.  This is the mechanism whereby support for additional
types of components can be added to \lmsbw (\xref{chap:extending}).
...
This variable is a normal \make variable.
...
Source components are declared to \lmsbw via
