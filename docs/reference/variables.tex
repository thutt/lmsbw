...
\texttt{component\_attribute\_api} API.

\subsubsection{\lmsbwcomponentfield{<component>}{build-target}}

This key holds the value specified with the
\texttt{component\_attribute\_build\_target}
(\xref{api:component-attribute-build-target}) API.
...
This key holds the value specified with the
\texttt{component\_attribute\_install\_target}
...
\texttt{component\_attribute\_no\_parallel\_build}
(\xref{api:component-attribute-no-parallel-build}) API.
...
This key is normally set through \texttt{component\_attribute\_api}
API.
