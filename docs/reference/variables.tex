...
In the example above, the function called \texttt{load\_configuration}\todo{xref this API}
...
\texttt{load-configuration-function}\todo{xref this API}
...
\texttt{declare\_component\_build\_target}\todo{xref this API} API.
...
This key holds the value specified with the
\texttt{declare\_component\_component}\todo{xref this API} API.
...
This key holds the value specified with the
\texttt{declare\_component\_configuration\_file}\todo{xref this API}
API.
...
This key holds the value specified with the
\texttt{declare\_component\_description}\todo{xref this API} API.
...
This key holds the value specified with the
\texttt{declare\_component\_install\_target}\todo{xref this API} API.
...
This value is set by \texttt{declare\_component\_kind}.\todo{xref this API}
...
This is set through the \texttt{declare\_component\_module}\todo{xref
  this API} API.
...
\texttt{declare\_component\_no\_parallel\_build}\todo{xref this API}
API.
...
This is set through the
\texttt{declare\_component\_prerequisite}\todo{xref this API}
API.
...
It is set through the \texttt{declare\_component\_reason}\todo{xref
  this API} API.
