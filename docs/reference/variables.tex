...
\item Key Value
  ...
  not been set for a component, then the compoment will be built.  If
...
\item{Download Script Must Be Declared}
  ...
  been declared, \lmsbw will exit with an apprpriate error
  message.
...
\item{Download Script Must Exist}
  ...
  exist, \lmsbw will exit with an apprpriate error message.
