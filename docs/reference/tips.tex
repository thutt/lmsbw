...
and \xref{variables:install-directory} for information on the
selection criteria for the directory; as long as the selection
criteria do not change, the install directory location will not change
either.
...
\todo{Need documentation criteria which makes this change}
...
\todo{Need documentation criteria which makes this change} \todo{Need
  documentation criteria which makes this change}
