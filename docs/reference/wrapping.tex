...
time for \lmsbw is longer than the incremental build
(\xref{samples:startup-time}) of your part of the project, you may be
able to perform some configuration magic to regain much of that lost
incremental development speed.  Here's how:
