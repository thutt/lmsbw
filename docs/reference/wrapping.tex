...
\section{Configuration Techniques}\label{wrap:techniques}
...
The are two prime action items when implementing a build wrapped by
\lmsbw:
...
\section{Component Build Process}\label{wrap:component-makefiles}
...
\item \texttt{build} target
  ...
  The \texttt{declare\_component\_build\_target} API allows you to
...
\item \texttt{install} target
  ...
  The \texttt{declare\_component\_install\_target} API allows you to
  change the target used to build a individual component.\todo{Need
    xref}
...
\section{Source Components}\label{wrap:source-components}
...
\begin{itemize}
\item{\texttt{declare\_component\_no\_parallel\_build}}
  (\xref{api:declare-component-no-parallel-build})
\item{\texttt{declare\_component\_build\_target}}  (\xref{api:declare-component-build-target})
\item{\texttt{declare\_component\_install\_target}} (\xref{api:declare-component-install-target})
\item{\texttt{declare\_component\_api}} (\xref{api:declare-component-api})
\end{itemize}
