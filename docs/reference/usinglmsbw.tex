...
(\xref{lmsbw:configuration}) will be placed into the named directory.
...
See \xref{chap:toolchain-usage} for details on selecting your
...
knowing the \destdir location is useful if you want to perform any
