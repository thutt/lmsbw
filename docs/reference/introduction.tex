...
implementation.  The lack of scoping a maintenance issue because the
\makefile developers have to be careful to avoid macro, target and
...
\item Recurse only when needed
  ...
  explicitly defined your component declarations.  In order to
  increase speed and decrease memory use, \lmsbw specifically
  maintains no dependency information about any source file contained
  in any component of your project.
