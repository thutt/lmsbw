...
\item Component Trampoline \makefile
  ...
  The second \makefile, still part of \lmsbw, that performs
  component-specific configuration such as configuring standard
  \makefile macros (\texttt{CC}, \texttt{LD}, etc.) that correspond to
  the toolchain (\xref{chap:toolchain-usage}) which will be used to
